...
static int usbaudio_ctrl_typeC_log_upload(void *data)
{
	...
	imonitor_set_param_integer_v2(obj, "E931001000_USBID_INT", (long)info->usb_id);
	imonitor_set_param_integer_v2(obj, "E931001000_IC_VARCHAR", (long)info->dev->manufacturer);
	imonitor_set_param_integer_v2(obj, "E931001000_MODULE_VARCHAR", (long)info->card->shortname);
	imonitor_set_param_integer_v2(obj, "E931001000_ISN_VARCHAR", (long)info->dev->serial);
	imonitor_set_param_integer_v2(obj, "E931001000_TIMES_INT", (long)insert_times);
	imonitor_set_param_integer_v2(obj, "E931001000_VER_INT", (long)info->dev->descriptor.bcdDevice);
